...
public class Persona {
	...
	public Persona(int idPersonas, String nombre, String direccion, Date fechaNacimiento, String nit, int edad,
	...
	public String toString() {
		return "Persona [idPersonas=" + idPersonas + ", nombre=" + nombre + ", direccion=" + direccion
				+ ", fechaNacimiento=" + fechaNacimiento + ", nit=" + nit + ", edad=" + edad + ", nombreCompleto="
				+ nombreCompleto + "]";
	}
